...
recipe "postgresql::replication",        "Internal recipe for replication base."
recipe "postgresql::replication_master", "Configures master node when replication is enabled."
recipe "postgresql::replication_slave",  "Configures slave node(s) when replication is enabled."
